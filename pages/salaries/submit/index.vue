  ...
  <div>
    <div class="text-center sm:my-5">
      ...
      <p class="mt-1 text-sm text-gray-500">
        Thông tin nhập của bạn sẽ được sẽ được đăng <b>ẩn danh</b> trên trang web. <br />Cùng nhau xây dựng bộ dữ liệu
        hữu ích cho tất cả mọi người nhé!
      </p>
    </div>
